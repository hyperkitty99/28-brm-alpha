...
class NoteSplash extends FlxSprite
{
	...
	public function new(x:Float = 0, y:Float = 0) {
		...
		if(states.PlayState.SONG.splashSkin != null && states.PlayState.SONG.splashSkin.length > 0) skin = states.PlayState.SONG.splashSkin;
	...
	public function setupNoteSplash(x:Float, y:Float, direction:Int = 0, ?note:Note = null) {
		...
		else if(states.PlayState.SONG.splashSkin != null && states.PlayState.SONG.splashSkin.length > 0) texture = states.PlayState.SONG.splashSkin;
		...
		if((note == null || note.noteSplashData.useRGBShader) && (states.PlayState.SONG == null || !states.PlayState.SONG.disableNoteRGB))
		{
