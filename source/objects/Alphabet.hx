...
class AlphaCharacter extends FlxSprite
{
	...
	public static var allLetters:Map<String, Null<Letter>> = [
		...
		//additional alphabet
		'á'  => null, 'à'  => null, 'ã'  => null, 'â'  => null, 'ä'  => null, 'å'  => null,
		'é'  => null, 'è'  => null, 'ê'  => null, 'ë'  => null, 'í'  => null, 'ì'  => null, 
		'î'  => null, 'ï'  => null, 'ó'  => null, 'ò'  => null, 'õ'  => null, 'ô'  => null, 
		'ö'  => null, 'ø'  => null, 'ú'  => null, 'ù'  => null, 'û'  => null, 'ü'  => null,
		'ç'  => {offsetsBold: [0, -11]},'æ'  => null, 'ñ'  => null, 'š'  => null, 'ł'  => null, 'ÿ'  => null, 
		'ý'  => null, 'ß'  => null, 'ӫ'  => null, 'Ӫ'  => null,
		...
		if(character != null) {
			...
			if(!bold) {
				if(isTypeAlphabet(lowercase)) 
					lowercase != this.character ? suffix = ' uppercase' : suffix = ' lowercase';
				else 
					suffix = ' normal';
			} else suffix = ' bold';
