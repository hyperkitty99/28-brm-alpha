...
class Note extends FlxSprite
{
	...
	public var noteSplashData:NoteSplashData = {
		...
		useRGBShader: (states.PlayState.SONG != null) ? !(states.PlayState.SONG.disableNoteRGB == true) : true,
		r: -1,
		g: -1,
		b: -1,
		a: 0.6
	...
	private function set_noteType(value:String):String {
		noteSplashData.texture = states.PlayState.SONG != null ? states.PlayState.SONG.splashSkin : 'noteSplashes';
		defaultRGB();
	...
	public function new(strumTime:Float, noteData:Int, ?prevNote:Note, ?sustainNote:Bool = false, ?inEditor:Bool = false, ?createdFrom:Dynamic = null)
	{
		...
		if(createdFrom == null) createdFrom = states.PlayState.instance;
		...
		if(noteData > -1) {
			...
			if(states.PlayState.SONG != null && states.PlayState.SONG.disableNoteRGB) rgbShader.enabled = false;
	...
	public function reloadNote(texture:String = '', postfix:String = '') {
		...
		if(texture.length < 1) {
			skin = states.PlayState.SONG != null ? states.PlayState.SONG.arrowSkin : null;
