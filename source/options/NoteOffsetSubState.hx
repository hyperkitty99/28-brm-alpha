...
class NoteOffsetSubState extends MusicBeatSubstate {
	...
	override public function create() {
		...
		beatText = new Alphabet(FlxG.width / 2, 0, getLocalizedString("beat_hit"), true);
	...
	function updateNoteDelay() {
		...
		timeTxt.text = getLocalizedString("current_offset") + ' ' + Math.floor(barPercent) + ' ' + getLocalizedString("ms");
	}
}