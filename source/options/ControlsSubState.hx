...
class ControlsSubState extends MusicBeatSubstate
{
	...
	var options:Array<Dynamic> = [
		[true, getLocalizedString("notes")],
		[true, getLocalizedString("left"), 'note_left', 'Note Left'],
		[true, getLocalizedString("down"), 'note_down', 'Note Down'],
		[true, getLocalizedString("up"), 'note_up', 'Note Up'],
		[true, getLocalizedString("right"), 'note_right', 'Note Right'],
		[true],
		[true, getLocalizedString("ui")],
		[true, getLocalizedString("left"), 'ui_left', 'UI Left'],
		[true, getLocalizedString("down"), 'ui_down', 'UI Down'],
		[true, getLocalizedString("up"), 'ui_up', 'UI Up'],
		[true, getLocalizedString("right"), 'ui_right', 'UI Right'],
		[true],
		[true, getLocalizedString("reset"), 'reset', 'Reset'],
		[true, getLocalizedString("accept"), 'accept', 'Accept'],
		[true, getLocalizedString("back"), 'back', 'Back'],
		[true, getLocalizedString("pause"), 'pause', 'Pause']
	];
	var curOptions:Array<Int>;
	var curOptionsValid:Array<Int>;
	var defaultKey:String = getLocalizedString("reset_to_default_keys");
