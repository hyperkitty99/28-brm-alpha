...
class WeekEditorState extends MusicBeatState
{
	...
	override function create() {
		...
		txtWeekTitle.setFormat(Paths.font("FallingSkyBd.otf"), 32, FlxColor.WHITE, RIGHT);
		...
		missingFileText.setFormat(Paths.font("FallingSkyBd.otf"), 24, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		...
		txtTracklist.font = Paths.font("FallingSkyBd.otf");
